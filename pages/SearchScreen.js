        ...
        fetch('https://bobsburgers-api.herokuapp.com/characters/', {
            ...
            .then((json) => {
                const filteredCharacters = json.filter((character) => {
                    ...
                    const searchData = this.state.searchData.toLowerCase();
                    return characterName.startsWith(searchData); // Menggunakan startsWith() untuk pencarian hanya dengan huruf pertama
                });
                this.setState({ dataCharacters: filteredCharacters }, () => console.log(filteredCharacters));
            })
            ...
            <View style={{ flex: 1 }}>
                <View style={{ flex: 3 }}>
                    <View style={{ height: 90, backgroundColor: '#fff', flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                        <View>
                            <TextInput
                                placeholder='Search name for a single character'
                        ...
                        <View>
                            <TouchableOpacity
                                style={{ backgroundColor: '#e15f41', paddingHorizontal: 15, paddingVertical: 13, borderRadius: 10, elevation: 5 }}
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            <View style={{ width: 160, height: 220, marginHorizontal: 5, marginBottom: 10, backgroundColor: '#e15f41', borderWidth: 1, borderRadius: 18, paddingHorizontal: 20, alignItems: 'center', justifyContent: 'center' }}>
